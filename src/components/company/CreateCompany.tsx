...
import { ImageIcon, ImageOff, ImageUp, Plus, Save, Upload } from "lucide-react";
import type { ErrorData } from "@/types/errors.interface";
import { toast } from "sonner";
import { Button } from "../ui/button";
import { createCompany } from "@/apis/company.apis";
import type { CompanyFormDataAdd } from "@/types/company.interface";
...
export default function CreateCompany() {
    ...
    const { mutate: mutateUpload } = useMutation({
        ...
        onSuccess: (data) => {
            ...
            newCompany.logotipo = data.result.publicUrl;
            setImageUpload(true);
        }
    })
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger>
                <Button
                    className="flex items-center justify-center gap-x-4 border border-gray-300 dark:border-gray-800 rounded-lg py-1 px-2 w-full md:w-auto"
                    onClick={() => {
                ...
                >
                    <div className="w-full">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                setNewCompany({ ...newCompany, nombre_empresa: e.target.value });
                            }}
                            minLength={3}
                            maxLength={50}
                            required
                    ...
                    <div className="w-full">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                setNewCompany({ ...newCompany, eslogan: e.target.value });
                            }}
                            minLength={5}
                            maxLength={150}
                        />
                    ...
                    <div className="w-full">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                setNewCompany({ ...newCompany, direccion_empresa: e.target.value });
                            }}
                            minLength={5}
                            maxLength={200}
                        />
                    ...
                    <div className="w-full">
                        ...
                        <input
                            ...
                            type="number"
                            onChange={(e) => {
                                setNewCompany({ ...newCompany, telefono_empresa: e.target.value });
                            }}
                            minLength={8}
                            maxLength={8}
                        />
                    ...
                    <div className="w-full">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                setNewCompany({ ...newCompany, celular_empresa: e.target.value });
                            }}
                            minLength={8}
                            maxLength={8}
                        />
                    ...
                    <div className="w-full">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                setNewCompany({ ...newCompany, correo_empresa: e.target.value });
                            }}
                            minLength={8}
                            maxLength={200}
                        />
