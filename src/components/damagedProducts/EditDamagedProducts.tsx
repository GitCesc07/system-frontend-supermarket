...
type ExpiredproductsFormEditProps = {
    damagedProducts: ExpiredProductsFormDataInfo,
    onClose: () => void
}

export default function EditDamagedProducts({ damagedProducts, onClose }: ExpiredproductsFormEditProps) {
    const navigate = useNavigate()
    const location = useLocation()
    const queryParams = new URLSearchParams(location.search)
    const expiredProductsId = queryParams.get("editDamagedProducts")!
    const [editExpiredProducts, setEditExpiredProducts] = useState(damagedProducts);
