...
import type { TempPurchasingFormData, TempPurchasingFormDataInfo } from "@/types/buys.interface";
...
export default function CreateExpiredProducts() {
    ...
    const [openAlertDialogDeleted, setOpenAlertDialogDeleted] = useState<TempPurchasingFormDataInfo | null>(null);
    const [dataProducts, setDataProducts] = useState<TempPurchasingFormDataInfo[]>(sessionStorage.getItem("tempProductsAddExpiredProducts") ? JSON.parse(sessionStorage.getItem("tempProductsAddExpiredProducts")!) : [])
    ...
    const getDataLocalStorage = (products: TempPurchasingFormDataInfo[]) => {
    ...
    const onSubmitCreateExpiredProducts = () => {
        ...
        // eslint-disable-next-line react-hooks/immutability
        newExpiredProducts.detalle_productos_expirado = dataStorage;
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent
                className="w-full h-[95%] md:max-w-lg scrollbar-thin-custom touch-pan-x touch-pan-y scroll-smooth overflow-scroll"
            ...
            >
                ...
                <fieldset className="flex flex-1 w-full h-full flex-col items-center mt-4 border border-gray-300 dark:border-gray-600 px-1 sm:p-4 rounded-lg py-4">
                                                                ...
                                                                <Tooltip>
                                                                    <TooltipTrigger>
                                                                        <button
                                                                            ...
                                                                            onClick={() => {
                                                                                setOpenAlertDialogDeleted(product);
                                                                            }}
                                                                        >
                ...
                <Button
                    variant="outline"
                    type="submit"
                    className="w-full mt-10 md:w-[50%] mx-auto border border-gray-300 dark:border-gray-800 py-2 px-4 rounded-md flex items-center justify-center gap-x-4 font-bold"
                    onClick={onSubmitCreateExpiredProducts}
                    aria-label="Close"
                >
